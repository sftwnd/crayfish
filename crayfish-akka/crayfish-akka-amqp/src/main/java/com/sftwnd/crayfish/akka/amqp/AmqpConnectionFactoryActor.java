...
import static com.sftwnd.crayfish.akka.amqp.AmqpConnectionFactoryActor.State.Connected;
import static com.sftwnd.crayfish.akka.amqp.AmqpConnectionFactoryActor.State.Init;
...
public class AmqpConnectionFactoryActor extends AbstractFSM<AmqpConnectionFactoryActor.State, Pair<ConnectionFactory, Connection>> {
    ...
    @Value("${com.sftwnd.crayfish.akka.amqp.max-reconnect-timeout:15000}")
    private long maxReconnectTimeout;

    @Value("${com.sftwnd.crayfish.akka.amqp.initial-timeout:1000}")
