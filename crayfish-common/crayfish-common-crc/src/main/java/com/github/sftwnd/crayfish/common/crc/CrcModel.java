...
public final class CrcModel extends CrcDescriprion {
    ...
    public static @Nullable CrcModel construct(@Nullable final String name, @Nullable final CrcDescriprion crcDescriprion, @Nullable final Long value) {
        return crcDescriprion == null ? null
             : getModels(m -> Optional.of(crcDescriprion)
                ...
                .sorted(Comparator.comparing(mdl -> modelNameFirst(mdl, name)))
                .findFirst()
                .orElseGet(() -> {
    ...
    public static @Nullable CrcModel construct(@Nullable final CrcDescriprion crcDescriprion, @Nullable final Long value) {
        return construct(null, crcDescriprion, value);
    }

    public static @Nullable CrcModel construct(@Nullable final CrcDescriprion crcDescriprion) {
    ...
    private static @NonNull CrcModel alias(@NonNull final String name, @NonNull CrcModel model) {
        return new CrcModel(name, model.getCrcDescriprion(), model.getCheck());
    }
