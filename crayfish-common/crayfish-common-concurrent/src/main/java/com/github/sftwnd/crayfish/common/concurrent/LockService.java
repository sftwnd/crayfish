...
public interface LockService {
    /**
     * Позволяет получить объект для получения/снятия именованной блокировки.
     * Блокировка получается на уровне треда, и является reentrable (т.е. тот-же тред может успешно несколько раз подряд
